...
# Utiliza una imagen OpenJDK 17 para la ejecución
...
COPY --from=build /app/build/libs/adaMongoDBClass-0.0.1-SNAPSHOT.jar .
...
CMD ["java", "-jar", "adaMongoDBClass-0.0.1-SNAPSHOT.jar"]